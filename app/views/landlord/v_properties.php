            ...
            <div class="property-card"
                ...
                <div class="property-info">
                    ...
                    <div class="property-details">
                        ...
                        <!-- Bedrooms & Bathrooms (hide for maintenance if 0) -->
                        <?php if (!$isMaintenanceProperty || ($property->bedrooms ?? 0) > 0): ?>
                            <p><strong>Bedrooms:</strong> <?php echo $property->bedrooms ?? 0; ?></p>
                        <?php endif; ?>

                        <?php if (!$isMaintenanceProperty || ($property->bathrooms ?? 0) > 0): ?>
                            <p><strong>Bathrooms:</strong> <?php echo $property->bathrooms ?? 0; ?></p>
                        <?php endif; ?>
